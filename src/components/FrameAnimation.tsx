...
const DEFAULT_IMAGES = [
    `${BASE_URL}assets/brandMarketing.jpeg`,
    `${BASE_URL}assets/contentCreating.jpeg`,
    `${BASE_URL}assets/contentMarketing.jpeg`,
    `${BASE_URL}assets/insta.jpeg`,
    `${BASE_URL}assets/Digital Marketing.jpeg`,
    `${BASE_URL}assets/facebook.jpeg`,
    `${BASE_URL}assets/influencing.jpeg`,
    `${BASE_URL}assets/content.jpeg`,
    `${BASE_URL}assets/youtube.jpeg`,
    `${BASE_URL}assets/PRManage.jpeg`,
    `${BASE_URL}assets/Editing.jpeg`,
    `${BASE_URL}assets/socialMedia.jpeg`,
    `${BASE_URL}assets/tiktok.png`,
    "",
];
...
function __OriginkitBase_ImageBox(props: Partial<ImageBoxProps>) {
    ...
    useEffect(() => {
        ...
        let pressed = false;
        let alive = true;
        let prevOccupiedSlots = new Set<number>();
        ...
        function populate(group: THREE.Group) {
            ...
            const currentOccupiedSlots = new Set<number>();

            for (let i = 0; i < slabs.length; i++) {
                const slab = slabs[i];
                // Skip if this segment doesn't take slabs, or if this slot was occupied in the previous segment, or random skip
                if (!takesSlabs || prevOccupiedSlots.has(i) || Math.random() > 0.5) {
                    slab.visible = false;
                    continue;
                }
                slab.visible = true;
            ...
            prevOccupiedSlots = currentOccupiedSlots;
        }
